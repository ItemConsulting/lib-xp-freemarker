...
public class FreemarkerPortalObjectImpl implements FreemarkerPortalObject {
   ...
   *
   * @param urlService Service for URL generation.
   ...
   */
  public FreemarkerPortalObjectImpl(PortalUrlService urlService, ViewFunctionService viewFunctionService, Supplier<PortalRequest> requestSupplier) {
